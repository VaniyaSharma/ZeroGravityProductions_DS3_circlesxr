...
// Update: now the URL passing works. And...
// implementation of carrying the seed automagically on load when carry=on or seedA, seedB etc
// picking up seed makes carry=on, dropping it makers carry=off, etc...
